...
public class ConsoleProcessor {
    ...
    private static tasks.caesar.CaesarCypher cypher;

    public ConsoleProcessor(tasks.caesar.CaesarCypher cypher) {
        this.cypher = cypher;
    ...
    private void processRead(File file) {
        String stringKey = getData("Укажите ключ или '-' если его нет");
        Integer key = null;
        ...
        if (key == null) {
            ...
            decryptedData = cypher.decrypt(encryptedData, key);
        }
